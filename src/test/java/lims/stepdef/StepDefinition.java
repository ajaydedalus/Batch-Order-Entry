...
public class StepDefinition {
	...
	@When("user click the Batch Order Entry")
	public void user_click_the_Batch_Order_Entry() throws InterruptedException {
		Thread.sleep(5000);
		WebElement menuOrderManagement = driver.findElement(By.xpath("//div[text()=' Order management ']"));
		menuOrderManagement.click();
		Thread.sleep(5000);
		WebElement btnBatchOrder = driver.findElement(By.xpath("//div[text()=' Batch order entry ']"));
		btnBatchOrder.click();
	}
	...
	public void user_enter_No_of_sample() {
		WebElement txtNumberOfSamples = driver.findElement(By.id("NumberOfSamples"));
		txtNumberOfSamples.sendKeys("2");
